  ...
  <div class="header">
    <div class="header-wrap">
      ...
      <div class="header-wrap-right">
        ...
        <div class="helpEntry">
          <el-dropdown trigger="hover" placement="bottom" @command="chooseItem">
            <div class="el-dropdown-icon">
              <img src="@/assets/images/common/helpEntry.png" alt />
            </div>
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item command="help">
                <div class="dropdown-item">
                  <img src="@/assets/images/common/help.png" alt />
                  <div class="dropdown-item-tip">帮助中心</div>
                </div>
              </el-dropdown-item>
              <el-dropdown-item command="feedback">
                <div class="dropdown-item">
                  <img src="@/assets/images/common/feedback.png" alt />
                  <div class="dropdown-item-tip">意见反馈</div>
                </div>
              </el-dropdown-item>
              <el-dropdown-item command="log">
                <div class="dropdown-item">
                  <img src="@/assets/images/common/log.png" alt />
